...
use tw_core::auth::ApiKey;
use uuid::Uuid;

// =============================================================================
// API Key Scope Verification Tests
// =============================================================================
...
fn test_api_key_has_scope_exact_match() {
    ...
    assert!(!api_key.has_scope("write"), "Should NOT have 'write' scope");
...
fn test_api_key_wildcard_scope_grants_all() {
    ...
    assert!(api_key.has_scope("any_scope"));
}
...
fn test_api_key_format_has_three_parts() {
    ...
    assert_eq!(
        parts.len(),
        3,
        "Raw key should have 3 parts separated by '_'"
    );
...
// =============================================================================
// Scope-Based Access Control Scenarios
// =============================================================================
...
// =============================================================================
// API Key User Association Tests
// =============================================================================
...
// =============================================================================
// API Key Security Properties Tests
// =============================================================================
...
#[test]
fn test_api_key_verification_is_consistent() {
    let user_id = Uuid::new_v4();
    let (api_key, raw_key) = ApiKey::new(user_id, "Test Key", vec!["read".to_string()]);
...
fn test_standard_scopes() {
    ...
    for scope in &valid_scopes {
        ...
        assert!(api_key.has_scope(scope), "Should have {} scope", scope);
    }
}
