...
| 2 | `20240102_000001_create_playbooks` | `20240130_000001_create_playbooks` | |
| 3 | `20240103_000001_create_connectors` | `20240130_000002_create_connectors` | |
| 4 | `20240104_000001_create_policies` | `20240130_000003_create_policies` | |
| 5 | `20240105_000001_create_notification_channels` | `20240130_000004_create_notification_channels` | |
| 6 | `20240106_000001_create_settings` | `20240130_000005_create_settings` | |
...
| 11 | `20240215_000002_add_tenant_id_to_tables` | `20240215_000002_add_tenant_id_to_tables` | SQLite version uses table recreation; PG uses ALTER TABLE |
...
| 13 | -- | `20240220_000002_enable_rls` | **PG-only.** Enables Row-Level Security on all tenant-scoped tables with per-tenant policies and helper functions. SQLite has no RLS equivalent. |
...
2. **`20240220_000002_enable_rls`** -- Enables PostgreSQL Row-Level Security
